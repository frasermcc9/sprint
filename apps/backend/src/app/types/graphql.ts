...
export interface IMutation {
  ...
  createRun(
    ...
    endTime: string,
    intensity: number,
  ): Nullable<Run> | Promise<Nullable<Run>>;
  createEvent(
    event: string,
    payload?: Nullable<string>,
  ): Nullable<AnalyticsEvent> | Promise<Nullable<AnalyticsEvent>>;
  addSleepVariable(
    name: string,
    emoji: string,
    custom: boolean,
    sleepDate: string,
  ): Nullable<VariableEditResponse> | Promise<Nullable<VariableEditResponse>>;
  removeSleepVariable(
    name: string,
    sleepDate: string,
  ): Nullable<VariableEditResponse> | Promise<Nullable<VariableEditResponse>>;
  ...
  updateExperienceLevel():
    | Nullable<ExperienceLevel>
    | Promise<Nullable<ExperienceLevel>>;
  completeOnboarding(
  ...
  createSleepVariable(
    emoji: string,
    name: string,
  ): SleepVariable | Promise<SleepVariable>;
